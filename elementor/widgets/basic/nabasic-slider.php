		...
		// Slider
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%' ],
					'selectors' => [
						'{{WRAPPER}} .napae-swiper-slide.swiper' => 'height:{{SIZE}}{{UNIT}};min-height:{{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
		...
		// Navigation
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-next, {{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-prev' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->start_controls_tabs( 'nav_arrow_style' );
				...
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-next:before, {{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-prev:before' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-next, {{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-prev' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_group_control(
					...
					[
						'name' => 'nav_border',
						'label' => esc_html__( 'Border', 'primary-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-next, {{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-prev',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-next:hover:before, {{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-prev:hover:before' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'type' => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-next:hover, {{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-prev:hover' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_group_control(
					...
					[
						...
						'label' => esc_html__( 'Border', 'primary-addon-for-elementor' ),
						'selector' => '{{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-next:hover, {{WRAPPER}} .napae-swiper-slide.swiper .swiper-button-prev:hover',
					]
				);
	...
	*/
	protected function render() {
		...
		ob_start();
		 ...
		 ?>
<div class="swiper napae-swiper-slide swiper-slides swiper-keyboard<?php echo esc_attr( $dot_class ); ?>" 
	<?php echo ($carousel_loop !== 'true') ? ' data-loop="true"' : ' data-loop="false"'; ?> 
	<?php echo ($carousel_autoplay_timeout) ? ' data-swiper-autoplay='. esc_attr( $carousel_autoplay_timeout ) .'' : ' data-swiper-autoplay=5000'; ?> 
	<?php echo ($carousel_speed) ? ' data-speed="'. esc_attr( $carousel_speed ) .'"' : ' data-speed="1000"'; ?> 
	<?php echo ($carousel_autoplay) ? ' data-autoplay="true"' : ' data-autoplay="false"'; ?> 
	<?php echo ($clickable_pagi) ? 'data-clickpage="true"' : ''; ?> 
	<?php echo (isset($settings['carousel_effect'])) ? ' data-effect="'.esc_attr( $carousel_effect ).'"' : ''; ?> 
	<?php echo ($carousel_mousedrag !== 'true') ? ' data-mousedrag="true"' : ' data-mousedrag="false"'; ?> 
